...
export default function DealCheckout({navigation, route}) {
  const {finalTotal, cafeId, menus} = route.params;
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.scrollViewContainer}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{height: sizes.screenHeight * 0.05}}></View>
          </ScrollView>
        </View>
        <DatePicker
          modal
