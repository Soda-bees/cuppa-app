...
export default function AdminAddEvent({navigation}) {
  ...
  return (
    <SafeAreaView>
      ...
      <Modal isVisible={modalCreatedEvent} onBackdropPress={handleCreatedEvent}>
        <View style={Platform.OS == 'android' ? styles.modalEventCreated : styles.modalEventCreatedIOS}>
          ...
          <Text style={styles.eventCreatedText}>
