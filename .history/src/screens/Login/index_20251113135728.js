...
import BottomBtn from '../../components/BottomBtnUser';
      ...
      <View style={styles.mainContainer}>
        ...
        {loader ? (
          ...
          <>
            ...
            />
            <BottomBtn title={'Sign In'} img={true} onPress={handleSignIn} />
            <BottomBtnLoader
              title={'Sign In'}
              img={true}
              onPress={handleSignIn}
            />
            <BottomButton title={'Sign In'} img={true} onPress={handleSignIn} />
          </>
        )}
        <TouchableOpacity
