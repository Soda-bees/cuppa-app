        ...
        <ScrollView
          ...
          <View style={Platform.OS == 'android' ? styles.body : styles.bodyIOS}>
            ...
            <Text style={styles.textBoldBlack2}>
              Welcome to <Text style={styles.bold}>Cuppa,</Text> where your
              coffee journey begins!
            </Text>
          </View>
          ...
          <View style={Platform.OS == 'android' ? styles.body : styles.bodyIOS}>
            ...
            <Text style={styles.textBoldBlack}>
              Order for pickup and support local coffee shops, one cup at a
              time! Your choice makes a difference in our{' '}
